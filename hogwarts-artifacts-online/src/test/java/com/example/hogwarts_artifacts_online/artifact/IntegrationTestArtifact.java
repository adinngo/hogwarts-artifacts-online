...
//                "Basic " + Base64Utils.encodeToString("john:123456".getBytes())));
    ...
    @Test
    void testSearchArtifactByDescription() throws Exception{
        ...
        this.mockMvc.perform(post(this.baseUrl + "/artifacts/search").accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json).params(requestParams))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    @Test
    void testSearchArtifactByNameAnDescription() throws Exception{
        Map<String, String> searchCriteria = new HashMap<>();
