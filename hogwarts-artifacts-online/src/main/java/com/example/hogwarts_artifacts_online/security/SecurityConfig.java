    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.
                ...
                .headers(headers -> headers.frameOptions(
                        frameOptionsConfig -> frameOptionsConfig.disable())) // this is for h2 browser console access
                .csrf(csrf -> csrf.disable())
                .cors(Customizer.withDefaults())
                .httpBasic(basicAuth
                        -> basicAuth.authenticationEntryPoint(this.customBasicAuthenticationEntryPoint))
